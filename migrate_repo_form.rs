...
impl crate::client::ResponseWrapper<crate::repository::Repository, MigrateRepoFormPostBuilder<crate::generics::CloneAddrExists, crate::generics::RepoNameExists, crate::generics::UidExists>> {
    #[inline]
