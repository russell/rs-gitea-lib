...
impl SearchResultsGetBuilder {
    ...
    #[inline]
    pub fn is_private(mut self, value: impl Into<bool>) -> Self {
        self.param_is_private = Some(value.into());
        self
    }
    ...
    pub fn archived(mut self, value: impl Into<bool>) -> Self {
        self.param_archived = Some(value.into());
        self
    }
...
impl<Client: crate::client::ApiClient + Sync + 'static> crate::client::Sendable<Client> for SearchResultsGetBuilder {
    ...
    fn modify(&self, req: Client::Request) -> Result<Client::Request, crate::client::ApiError<Client::Response>> {
        ...
        .query(&[
            ...
            ("archived", self.param_archived.as_ref().map(std::string::ToString::to_string)),
