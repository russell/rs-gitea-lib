...
pub struct CreateMilestoneOption {
    ...
    pub state: Option<crate::create_milestone_option::CreateMilestoneOptionState>,
...
impl Default for CreateMilestoneOptionState {
    fn default() -> Self {
        CreateMilestoneOptionState::Open
    }
}
...
impl CreateMilestoneOptionBuilder {
    ...
    #[inline]
    pub fn state(mut self, value: crate::create_milestone_option::CreateMilestoneOptionState) -> Self {
