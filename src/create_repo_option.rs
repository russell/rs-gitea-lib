...
pub struct CreateRepoOption {
    ...
    pub trust_model: Option<crate::create_repo_option::CreateRepoOptionTrustModel>,
}
...
impl Default for CreateRepoOptionTrustModel {
    fn default() -> Self {
        CreateRepoOptionTrustModel::Default
    }
}
...
impl CreateRepoOption {
    ...
    #[deprecated]
    #[inline]
    pub fn create_org_repo_deprecated() -> CreateRepoOptionPostBuilder1<crate::generics::MissingOrg, crate::generics::MissingName> {
    ...
    #[inline]
    pub fn create_org_repo() -> CreateRepoOptionPostBuilder2<crate::generics::MissingOrg, crate::generics::MissingName> {
    ...
    #[inline]
    pub fn create_current_user_repo() -> CreateRepoOptionPostBuilder3<crate::generics::MissingName> {
        CreateRepoOptionPostBuilder3 {
            body: Default::default(),
            _name: core::marker::PhantomData,
        }
    }
...
impl Into<CreateRepoOption> for CreateRepoOptionPostBuilder2<crate::generics::OrgExists, crate::generics::NameExists> {
    fn into(self) -> CreateRepoOption {
        self.inner.body
    }
}

impl Into<CreateRepoOption> for CreateRepoOptionPostBuilder3<crate::generics::NameExists> {
    fn into(self) -> CreateRepoOption {
        self.body
    }
}
...
impl<Name> CreateRepoOptionBuilder<Name> {
    ...
    /// TrustModel of the repository
    #[inline]
    pub fn trust_model(mut self, value: crate::create_repo_option::CreateRepoOptionTrustModel) -> Self {
        self.body.trust_model = Some(value.into());
        self
    }
}
...
impl<Username, Name> CreateRepoOptionPostBuilder<Username, Name> {
    ...
    #[inline]
    pub fn trust_model(mut self, value: crate::create_repo_option::CreateRepoOptionTrustModel) -> Self {
        self.inner.body.trust_model = Some(value.into());
        self
    }
}
...
/// Builder created by [`CreateRepoOption::create_org_repo_deprecated`](./struct.CreateRepoOption.html#method.create_org_repo_deprecated) method for a `POST` operation associated with `CreateRepoOption`.
#[repr(transparent)]
#[derive(Debug, Clone)]
...
#[repr(transparent)]
#[derive(Debug, Clone)]
pub struct CreateRepoOptionPostBuilder2<Org, Name> {
    inner: CreateRepoOptionPostBuilder2Container,
    _param_org: core::marker::PhantomData<Org>,
    _name: core::marker::PhantomData<Name>,
}

#[derive(Debug, Default, Clone)]
struct CreateRepoOptionPostBuilder2Container {
    body: self::CreateRepoOption,
    param_org: Option<String>,
}

impl<Org, Name> CreateRepoOptionPostBuilder2<Org, Name> {
    /// name of organization
    #[inline]
    pub fn org(mut self, value: impl Into<String>) -> CreateRepoOptionPostBuilder2<crate::generics::OrgExists, Name> {
        self.inner.param_org = Some(value.into());
        unsafe { std::mem::transmute(self) }
    }
    ...
    /// Name of the repository to create
    #[inline]
    pub fn name(mut self, value: impl Into<String>) -> CreateRepoOptionPostBuilder2<Org, crate::generics::NameExists> {
        self.inner.body.name = value.into();
        unsafe { std::mem::transmute(self) }
    }
...
impl<Client: crate::client::ApiClient + Sync + 'static> crate::client::Sendable<Client> for CreateRepoOptionPostBuilder2<crate::generics::OrgExists, crate::generics::NameExists> {
    type Output = crate::repository::Repository;
...
impl crate::client::ResponseWrapper<crate::repository::Repository, CreateRepoOptionPostBuilder2<crate::generics::OrgExists, crate::generics::NameExists>> {
    #[inline]
    pub fn message(&self) -> Option<String> {
        self.headers.get("message").and_then(|v| String::from_utf8_lossy(v.as_ref()).parse().ok())
    }
...
#[derive(Debug, Clone)]
pub struct CreateRepoOptionPostBuilder3<Name> {
    body: self::CreateRepoOption,
    _name: core::marker::PhantomData<Name>,
}

impl<Name> CreateRepoOptionPostBuilder3<Name> {
    /// Whether the repository should be auto-intialized?
    #[inline]
    pub fn auto_init(mut self, value: impl Into<bool>) -> Self {
        self.body.auto_init = Some(value.into());
    ...
    /// Name of the repository to create
    #[inline]
    pub fn name(mut self, value: impl Into<String>) -> CreateRepoOptionPostBuilder3<crate::generics::NameExists> {
        self.body.name = value.into();
        unsafe { std::mem::transmute(self) }
    }
...
impl<Client: crate::client::ApiClient + Sync + 'static> crate::client::Sendable<Client> for CreateRepoOptionPostBuilder3<crate::generics::NameExists> {
    type Output = crate::repository::Repository;
...
impl crate::client::ResponseWrapper<crate::repository::Repository, CreateRepoOptionPostBuilder3<crate::generics::NameExists>> {
    #[inline]
    pub fn message(&self) -> Option<String> {
        self.headers.get("message").and_then(|v| String::from_utf8_lossy(v.as_ref()).parse().ok())
    }
