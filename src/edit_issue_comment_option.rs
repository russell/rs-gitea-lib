...
impl crate::client::ResponseWrapper<crate::comment::Comment, EditIssueCommentOptionPatchBuilder<crate::generics::OwnerExists, crate::generics::RepoExists, crate::generics::IdExists, crate::generics::BodyExists>> {
    #[inline]
...
impl crate::client::ResponseWrapper<crate::comment::Comment, EditIssueCommentOptionPatchBuilder1<crate::generics::OwnerExists, crate::generics::RepoExists, crate::generics::IndexExists, crate::generics::IdExists, crate::generics::BodyExists>> {
    #[inline]
    pub fn message(&self) -> Option<String> {
        self.headers.get("message").and_then(|v| String::from_utf8_lossy(v.as_ref()).parse().ok())
    }
